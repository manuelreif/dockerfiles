...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Logical")
    parser.add_argument("--word_sum_file", type=str, help="Der Pfad zur Wortsummendatei!", required=True)
    parser.add_argument("--outfile", type=str, help="Der Pfad zur Ausgabedatei!", required=True)

    args = parser.parse_args()

    solve_logical(args.word_sum_file, args.outfile)
